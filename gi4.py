...
gye = LINE("EwP3Wvg4BifAGJqZdtZ0.OKWky3kb60pcfWQ/EMbTGa.OkmkcLYLQoO2cB30J5zuu4G2QRCWGPWKIF81PAqbYvg=")
ais = LINE("EwOF5PzV1nCRzp1HXIR5.BAbZE0umy2dUOSbpoBpzPq.BjbyxjgTnvC2Li3UxiSBv2IEdoLUqOqL/t0L0b7Cc8w=")
ki2 = LINE("EwZbV0kpBcsv9UFA6awc.YCFgbMZPhmkVN+eVj380ta.7oJpqXS+01sf1RiCaX454iujbtqfFKtG3pQiTR4cdcU=")
ki3 = LINE("EwxPjx6FzJRhf5dxpFZf.jcKRHQZO/ZUdXspu91JKJW.CP+utVopNLcOQVPGas9zRCwI4qLc2q2MITXEVFuHfgo=")
ki4 = LINE("EwP3Wvg4BifAGJqZdtZ0.OKWky3kb60pcfWQ/EMbTGa.OkmkcLYLQoO2cB30J5zuu4G2QRCWGPWKIF81PAqbYvg=")
...
creator = ["ua24c0a637281eb43c2170abe7a606d80"]
Owner = ["ua24c0a637281eb43c2170abe7a606d80"]
admin = ["ua24c0a637281eb43c2170abe7a606d80"]
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    gye.sendContact(to, "ua24c0a637281eb43c2170abe7a606d80")
                    gye.sendMessage(to,"\n\n")
...
#-------------------------------------------------------------------------------
             ...
             #       if msg._from in Owner:
                        ...
                        gye.sendMessage(msg.to,"All Protect Set To Mati")
            #        else:
...
#==============================================================================#
                    ...
                    gye.sendContact(to, gyeMID)
                    gye.sendMessage(msg.to,"Jangan Nakal yee")
...
#-------------------------------------------------------------------------------
                        ...
                        gye.sendMessage(msg.to,"Bot 1")
                        ais.sendMessage(msg.to,"Bot 2")
                        ki2.sendMessage(msg.to,"Bot 3")
                        ki3.sendMessage(msg.to,"Bot 4")
                        ki4.sendMessage(msg.to,"Bot 5")
                        gye.sendMessage(msg.to,"Jangan Nakal yee")
