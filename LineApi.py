...
class LINE:
  ...
  def __init__(self):
    ...
    self._headers = {'X-Line-Application': 'IOSIPAD \ t 7.14.0 \ t iPhone OS \ t 10.12.0 ' }
  ...
  def login(self, mail=None, passwd=None, cert=None, token=None, qr=False, callback=None):
    ...
    self._headers = {
              'X-Line-Application': 'DESKTOPWIN 8.2.2 CITL_DESIGN 12.0.2',
              #'X-Line-Application': 'CHROMEOS\x091.4.13\x09Chrome_OS\x091',
