...
cl = LINETCR.LINE()
cl.login(token="EzxqUuxUuZME7XoIpRA0.9q2iIcfJltjghJCvoSD1Wa.hARyw9ye6hXFSh4VTnPsbY22sAV12H42g15Q3FP5snE=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Ez0StrFecgT4iPR9Ky65.BAbZE0umy2dUOSbpoBpzPq.2pNqYatNe7GiKlTz9bWfovaD1+FfdiYOH4f/rl4oB84=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EzbEIOWvlHcGQyWNBXSc.YCFgbMZPhmkVN+eVj380ta.REISdFmHH8uq3LUXcMd5odnOr19DXnlGkd7AFY9BBcQ=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="EzbWsmcZRCl0OG9NJtTf.jcKRHQZO/ZUdXspu91JKJW.8vhTGKKOpI2pq/aygaECcEOe9pG68YXy+rZ2gD7auQc=")
kc.loginResult()

kb = LINETCR.LINE()
kb.login(token="EzWsWDY6JxhmD1VBSYN2.a3wwcrKoF7GSYZK8iLIneG.fUoHgXARBgAHMWkoS8rgaa6cPzdoro/05CSgyCl4ng8=")
kb.loginResult()

kd = LINETCR.LINE()
kd.login(token="EzToPHChs60AqjcYtbfc.lRANtBt0XNe7AUiARUwHRa.Pv9Rp1CQNSMppeGANtSDYEvdPU5u9WRkQ2kx262+7OU=")
kd.loginResult()
ke = LINETCR.LINE()
ke.login(token="EzY3Z6vfe20BhAp4e9c2./LjutxDotUFL1qqbWYLg0G.BsKzdm6DZbuy3t9HIdPNRyFkthPrb5/WVVENL4R6r3g=")
ke.loginResult()
kg = LINETCR.LINE()
kg.login(token="EzzcJwDraSFCIyZDpcv7.oPKFjbf2tqL/DROHWdwRXW.t6JX2QVg4Nx0B1bXHB04yOC1clMn+qfMn5aZA3t+W9k=")
kg.loginResult()
kh = LINETCR.LINE()
kh.login(token="EzFqffMf5EsED2HMupG4.q5eKTus+y7F5Lcc39+6ADa.6iGsqrm3HQQnNcIS4DMb13JzImaXq8Jnewc+2qpzizs=")
kh.loginResult()
kl = LINETCR.LINE()
kl.login(token="Ez4vtPjBhdMrCIgKtBUc.z4y1C6W70neuRJnWGivNZa.J3/Jeyl/zj/w66ntbmSUDv7kvRqSRuZiGY8ZJWDjFLA=")
kl.loginResult()
kt = LINETCR.LINE()
kt.login(token="EzCGphbWdFrzE1He0lz6.fil0fVEpy07SxIHYe/xGrG.Q7pjrWBUi+zO8mJOjDHTAArtgzuviQpEFOZ/9yItQjE=")
kt.loginResult()
kz = LINETCR.LINE()
kz.login(token="Ezwsw01DOoZFxgEGWLL9.pzD1VRZEG6ip2fZxru4LIq.7wCOpKro3bZwmfK1GLvNGNNUiG55cX3fecIfxc+DdFI=")
kz.loginResult()
sw = LINETCR.LINE()
sw.login(token="EzjouTP630BCpQIWJaP0.wa8B30bh0DW1uW057OP4ma.RnZ6vm216ryVyiPfuuJCS9bIl8L5hXQ5c0jccFUxd1o=")
sw.loginResult()
	     ...
	     if msg.from_ in admin:
             ...
             if msg.from_ in admin:
              if msg.toType == 2:
                ...
                profile.displayName = X
                kl.updateProfile(profile)
                kl.sendText(msg.to,"name " + X + " done")
              else:
                kl.sendText(msg.to,"Failed")
             ...
             if msg.from_ in admin:
              if msg.toType == 2:
                ...
                profile.displayName = X 
                kt.updateProfile(profile)
                kt.sendText(msg.to,"name " + X + " done")
              else: 
             ...
             if msg.from_ in admin:
              if msg.toType == 2:
                ...
                profile.displayName = X
		kz.updateProfile(profile)
		kz.sendText(msg.to,"Changed ==[ " + X + " ]== Succes")
	      else:
		kz.sendText(msg.to,"Failed")
...
#---------------------------------------------------------------------------------------------
	      ...
	      if msg.from_ in admin:
                if wait["protectJoin"] == True:
                    ...
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Kick Hati janda On")
                    else:
                        cl.sendText(msg.to,"done")
                if wait["protect"] == True:
                    if wait["lang"] == "JP":
                    ...
                    wait["protect"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Kick kojom ON")
                    else:
                        cl.sendText(msg.to,"Kick kojom On")
                if wait["linkprotect"] == True:
                    if wait["lang"] == "JP":
                    ...
                    wait["linkprotect"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Kick desahan On")
                    else:
                        cl.sendText(msg.to,"ProtectQR already On")
                if wait["inviteprotect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Kick maling sempak  On")
                    else:
                        cl.sendText(msg.to,"Kick maling sempak ON")
                else:
                    wait["inviteprotect"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Kick kojomON")
                    else:
                        cl.sendText(msg.to,"Kick kojom On")
                if wait["cancelprotect"] == True:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Kick maling sempakOn")
                else:
                    wait["cancelprotect"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Kick tukang nyabun ON")
                    else:
                        cl.sendText(msg.to,"Kick curi slingkuhan On")
#-----------------------------------------------------------------------------------------
            elif msg.text in ["Allprotect off","Sw off","S off"]:
              if msg.from_ in admin:
                if wait["protectJoin"] == False:
		    if wait["lang"] == "JP":
			cl.sendText(msg.to,"Kick hati janda Off")
                    else:
                        cl.sendText(msg.to,"Kick hati janda Off")
                else:
		    wait["protectJoin"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"kick Kojom Off")
                    else:
                        cl.sendText(msg.to,"done")
                if wait["protect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Kick desahan off")
                    else:
                        cl.sendText(msg.to,"kick desahan off")
                else:
                    wait["protect"] = False
                ...
                if wait["linkprotect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Kick maling sempak off")
                    else:
                        cl.sendText(msg.to,"Kick maling sempakoff")
                else:
                    wait["linkprotect"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Kick maling Bh off")
                    else:
                        cl.sendText(msg.to,"Kick maling sempak Off")
                if wait["inviteprotect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Kick nyolong slingkuhan Off")
                    else:
                        cl.sendText(msg.to,"Kick tukang nyabun off")
                else:
                    wait["inviteprotect"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Kick nyabun off")
                    else:
                        cl.sendText(msg.to,"Kick tukang nyabun off")
...
#----------------------------------------------------------------------------------------------
		...
		cl.sendText(msg.to,md + "╚═════════════\n\n     🔐 🔰SABLENK BOTS🔰「👻�1�7�1�7")
	      ...
	      if msg.from_ in admin:
            ...
            elif msg.text in ["Backup on","Bk on"]:
	      if msg.from_ in admin:
                if wait["Backup"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Already On")
	      ...
	      if msg.from_ in admin:
		    ...
		    group = kc.getGroup(msg.to)
                    ...
                    if matched_list == []:
                        ...
                        kg.sendText(msg.to,"There was no blacklist user")
                        kh.sendText(msg.to,"There was no blacklist user")
