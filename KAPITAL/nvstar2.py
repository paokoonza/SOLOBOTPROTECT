# -*- coding: utf-8 -*-
#thrift.unverting import * #
#thrift.TMultiplexedProcessor import * #
#thrift.TSerialization import * #
...
kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EzWsWDY6JxhmD1VBSYN2.a3wwcrKoF7GSYZK8iLIneG.fUoHgXARBgAHMWkoS8rgaa6cPzdoro/05CSgyCl4ng8=')
kr.loginResult()
print "Kr-Login Success\n"

km = LINETCR.LINE()
#km.log
km.login(token='EzqCh7PQ2mgQdu3gd1Db.d+8dm1wfnENnVH33/TFNkW.05/kyWbmfGPVwuBVNaxbm0pqDWmDZpH8jzkKqiG3e6k=')
km.loginResult()
...
╚═════════════════════════
"""
gerhanaselatan="uf50d888821632d32461e37153ac775c0"
...
Creator=["uf50d888821632d32461e37153ac775c0","u2eb6a74db4f4c6713b6ae21aaee5a1ac","u6da0737b450c6360eea2c04f39b3d9a5"]
admin=["uf50d888821632d32461e37153ac775c0","u6da0737b450c6360eea2c04f39b3d9a5","uc9c7c6066ce91cc2af9ff12f277f344c","u24292b86ace8fb3b83c523d4f758e48f","u03759609190e7fb82ccb393c22588d12","u2eb6a74db4f4c6713b6ae21aaee5a1ac"]
...
wait = {
    ...
    "comment4":"Nice Kak (^_^)",
    "comment5":"Bot Auto Like ©By : Sadis\nContact Me : 👉 line.me/ti/p/~gerhanaselatan",    
    "commentOn":True,
    "commentBlack":{},
    ...
    try:
        ...
        if op.type == 17:
          if wait["Sambutan"] == True:
            ...
            cl.sendMessage(c)
            cl.sendText(op.param1,"Hallo " + cl.getContact(op.param2).displayName + "\nWelcome To ☞ " + str(ginfo.name) + " ☜" + "\nBiasakan kasih desah dl yaa\nSemoga Betah Dimari,, ^_^")
	 ...
	 if wait["Ghost"] == True:
        ...
        if op.type == 25:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["kickMention"] == True:
                     ...
                     balas = ["Gw Bilang Jangan tag Lagi " + cName + "\nGw Kick Kamu! Sorry, Byee!!!"]
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["klo nge tag lagi, gw tikung tw rasa!","Dont Tag!! Lagi  Kelon jangan ganggu",cName + " Hadeh pusing gw?",cName + " Tag teg kaya tukan kredit aja lu,,","Njirr ngajak nikung eaa","Abang sibuk ", cName + " Tag lagi.. Kangen ama anu yee hahaha?","Abang Lagi Bobok,,\nJangan Di Tag lagi yaa " + cName, "Jangan Suka Tag Gua,,kenal jg kg " + cName, "Kamu oh kamu,, " + cName + "?", "Ada Perlu Apa " + cName + "?","Woii " + cName + " Jangan tag yee,,gw lagi kelon"]
                     ret_ = random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
			...
			cl.sendText(msg.to,"Admin Detected~")
                ...
                cl.sendMessage(msg)
		cl.sendText(msg.to,"Itu Bosku (^_^)")
		
            elif msg.text in ["Admin","admin"]:
                msg.contentType = 13
                admin1 = "uf50d888821632d32461e37153ac775c0"
                admin2 = "u6da0737b450c6360eea2c04f39b3d9a5"
                admin3 = "uc9c7c6066ce91cc2af9ff12f277f344c"
                msg.contentMetadata = {'mid': 'uf50d888821632d32461e37153ac775c0'}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': 'uf50d888821632d32461e37153ac775c0'}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': 'u6da0737b450c6360eea2c04f39b3d9a5'}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': 'uc9c7c6066ce91cc2af9ff12f277f344c'}
                random.choice(KAC).sendMessage(msg)                
		random.choice(KAC).sendText(msg.to,"Itu Anuku(^_^)")	
              ...
              if msg.from_ in Creator:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.append(target)
                            cl.sendText(msg.to,"Admin bot Ditambahkan")
                        except:
                            pass
              ...
              if msg.from_ in Creator:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.remove(target)
                            cl.sendText(msg.to,"Admin bot Dihapus")
                        except:
                            pass
		...
		if msg.from_ in Creator:
                    for i in gid:
                        h = cl.getGroup(i).name
		        if h == ng:
			    cl.sendText(i,"Bot Di Paksa Pulang Oleh yg punya!")
		         #   cl.leaveGroup(i)
			    ki.leaveGroup(i)
			    kk.leaveGroup(i)
			    kc.leaveGroup(i)
	    ...
	    elif "Lip all group" == msg.text:
		gid = cl.getGroupIdsJoined()
                if msg.from_ in Creator:
		    for i in gid:
			cl.sendText(i,"Bot Di Paksa pulang!")
		       # cl.leaveGroup(i)
			ki.leaveGroup(i)
			kk.leaveGroup(i)
			kc.leaveGroup(i)
            ...
            elif msg.text in ["clink","Cancelall"]:
                if msg.toType == 2:
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to,"iya saya aja")		    
		    
 
            elif msg.text in ["Rp on"]:
		if msg.from_ in admin:
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to,"saya yang itu")
...
#	     if msg.from_ in admin:	        
		...
		print wait["AutoCancel"]
#	     else:
#		    cl.sendText(msg.to,"Saya itu yg anu")	
...
#		if msg.from_ in admin:
                    ...
                    wait["Qron"] = True
                    wait["Ghost"] = True     
                    cl.sendText(msg.to,"Semua bot dihidupkan")
		    print wait["AutoCancel"]
		    print wait["AutoKick"]
		    print wait["Qr"]
#		else:
...
#		if msg.from_ in admin:
                    ...
                    wait["Qron"] = False
                    wait["Ghost"] = False 
                    cl.sendText(msg.to,"Bot Di Nonaktifkan Semua")
		    print wait["AutoCancel"]
		    print wait["AutoKick"]
		    print wait["Qr"]
#		else:                    
...
#		    cl.sendText(msg.to,"Khusus Nadya")
                ...
                wait["Sider"] = True
                cl.sendText(msg.to,"Siap  Cek Anu")
                
            elif "Sd off" in msg.text:
		...
		if midd not in admin:
		    ...
		    cl.sendText(msg.to,"Admin Detected")
                ...
                midd = "uf50d888821632d32461e37153ac775c0"
                random.choice(KAC).inviteIntoGroup(msg.to,[midd])
		...
		if msg.from_ in Creator:
            ...
            elif msg.text.lower() in ["bot","Bang"]:
                cl.sendText(msg.to,"Apa Manggil~Manggil Aku!?") 
                cl.sendText(msg.to,"☆pm aja ☞klo kangen☜ Untuk Bantuan☆") 
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to, "Khusus abang")
            ...
            elif "Wahing" == msg.text:
		    if msg.from_ in Creator:
                     if msg.toType == 2:
                        print "Kick all member"
                        _name = msg.text.replace("Wahing","")
                        gs = ki.getGroup(msg.to)
                        gs = kk.getGroup(msg.to)
                        gs = kc.getGroup(msg.to)
                        ki.sendText(msg.to,"Hahahah")
                        kc.sendText(msg.to,"Nah kapok~")
                        targets = []
                        for g in gs.members:
		...
		if msg.from_ in Creator:
            ...
            elif "Curi @" in msg.text:
                if msg.toType == 2:
                    cover = msg.text.replace("Curi @","")
                    _nametarget = cover.rstrip('  ')
                    gs = cl.getGroup(msg.to)
                    targets = []
                    for g in gs.members:
                ...
                if targets ==[]:
                        ...
                        for target in targets:
                                try:
                                        ...
                                        km.sendText(msg.t,"Terbuang hhhhh....")
                                        km.sendText(msg.to,"Santay lur besok kita desah....!!!")
                                        km.leaveGroup(msg.to)
                                        gs = cl.getGroup(msg.to)
