...
cl.login(token="Ezi6IOzD81G62jtF47c0.9q2iIcfJltjghJCvoSD1Wa.wKpErdw82yEAdHjRiEa6CAzLSOdcCuGmJ9QR6lao10o=")
cl.loginResult()

ki = LINETCR.LINE()
#ki.login(token="Eyfg6QGFHBFUFC8ZtkZ5.BAbZE0umy2dUOSbpoBpzPq.lXD2kRtVC24dED2mukQS8SWJq69jiPdbdSwYttfrEQg=")
ki.login(token="Ez5iIp22OHY2DeQ5I955.BAbZE0umy2dUOSbpoBpzPq.vx8e/Ynmy71pc9UDAyybFKDpVa0yYNvmPVx4U+FUbVQ=")
ki.loginResult()

kk = LINETCR.LINE()
#kk.login(token="Ey870DEVeRttxWG0kULc.YCFgbMZPhmkVN+eVj380ta.iJVSxeD+bc4PA1LUDs7vsCeCDLPRUCzX4+9TVC4HQfE=")
kk.login(token="Ez1F9J2fnbfdVikl9fRc.YCFgbMZPhmkVN+eVj380ta.MQmv7tMdtfDLHgeimKol1fiauu6WF/Qsto33Yw8GvA4=")
kk.loginResult()

kc = LINETCR.LINE()
#kc.login(token="EyAO2wLu8PnLKEIxWZQf.jcKRHQZO/ZUdXspu91JKJW.qIV6DwN1HjPrUW6pq0JghQDflEV0c/mlCsPIn3SG/zM=")
kc.login(token="Ez5SlZ0XP52yeaV9Z7Sf.jcKRHQZO/ZUdXspu91JKJW.01ffVQi0GtG7u4A9KDULKva6k46yxlgTqKqm3nYoM6k=")
kc.loginResult()

kb = LINETCR.LINE()
#kb.login(token="EyCivT3oBbQGe4azowY2.a3wwcrKoF7GSYZK8iLIneG.P2ZAwWDZRfny1TV8lUIguyLE+N19zD7Fb6KPLEv/H3w=")
kb.login(token="EzOdHeA7Em0OgG0Hq5v2.a3wwcrKoF7GSYZK8iLIneG.1qxewEMWNbXx+KeazNjF8LlNQdD3WdWPsovwZDfBNCo=")
kb.loginResult()

kd = LINETCR.LINE()
#kd.login(token="EyHnUCm4FRj6OhuMDFpc.lRANtBt0XNe7AUiARUwHRa.KjwS09ZHV20cUlfGjeQEDjdt6fANy5XL7lrj0gUj/uY=")
kd.login(token="Ez37czJA6LBUODe97dvc.lRANtBt0XNe7AUiARUwHRa.0TRufVTyvUAWzzC5cNnUqctr9xNlSfPWmNMvFcuRDNs=")
kd.loginResult()

ke = LINETCR.LINE()
#ke.login(token="EyHnUCm4FRj6OhuMDFpc.lRANtBt0XNe7AUiARUwHRa.KjwS09ZHV20cUlfGjeQEDjdt6fANy5XL7lrj0gUj/uY=")
ke.login(token="EzDnJ8EihEtebiXrHOO2./LjutxDotUFL1qqbWYLg0G.gxKuSsA+Qi3Q+tBudafSkC34G6fpDY5VclG7K0FjSdM=")
ke.loginResult()

kg = LINETCR.LINE()
#kg.login(token="EyHnUCm4FRj6OhuMDFpc.lRANtBt0XNe7AUiARUwHRa.KjwS09ZHV20cUlfGjeQEDjdt6fANy5XL7lrj0gUj/uY=")
kg.login(token="EzVE19ZQjjDx6UezRupb.d+8dm1wfnENnVH33/TFNkW.0AD1ost6xqfxKWk0GUIur0FIyC35RnhhS0Ra1vTYhRk=")
kg.loginResult()

kh = LINETCR.LINE()
#kh.login(token="EyHnUCm4FRj6OhuMDFpc.lRANtBt0XNe7AUiARUwHRa.KjwS09ZHV20cUlfGjeQEDjdt6fANy5XL7lrj0gUj/uY=")
kh.login(token="EzkbVu7srRYVjfyFZKU4.q5eKTus+y7F5Lcc39+6ADa.rhgFcGNdP6ZhyOWYpJLWSkUtPFAqjiUHdaBiWKtpr/0=")
kh.loginResult()

kl = LINETCR.LINE()
#kl.login(token="EyHnUCm4FRj6OhuMDFpc.lRANtBt0XNe7AUiARUwHRa.KjwS09ZHV20cUlfGjeQEDjdt6fANy5XL7lrj0gUj/uY=")
kl.login(token="Ez3YeV8QFW3q8MDhG5Gc.z4y1C6W70neuRJnWGivNZa.BxIkyWAnTBsktuJFEHwdxHDvdPvQNy15fAGoepf2SvU=")
kl.loginResult()

kt = LINETCR.LINE()
#kt.login(token="EyJRThyRWbxBn6pflCS0.9q2iIcfJltjghJCvoSD1Wa.5a2TU/6Ie+TzDCURSsFl2ka1/vSnTDDE40/N2zQ3ZGY=")
kt.login(token="Ez3M1SwsbMivh7nYlmn6.fil0fVEpy07SxIHYe/xGrG.8WriQUNtCpZzDBdce4VS2MnKfSs5dcdL+DwZhoHPZ1w=")
kt.loginResult()

kz = LINETCR.LINE()
#kz.login(token="EyJRThyRWbxBn6pflCS0.9q2iIcfJltjghJCvoSD1Wa.5a2TU/6Ie+TzDCURSsFl2ka1/vSnTDDE40/N2zQ3ZGY=")
kz.login(token="EzCxb3EzIyIhUNl4wDt9.pzD1VRZEG6ip2fZxru4LIq.a8OX3a5cIOtrm7s+x7fIJvLMmDhGDevOs+eud96mBHQ=")
kz.loginResult()

sw = LINETCR.LINE()
#sw.login(token="EyJRThyRWbxBn6pflCS0.9q2iIcfJltjghJCvoSD1Wa.5a2TU/6Ie+TzDCURSsFl2ka1/vSnTDDE40/N2zQ3ZGY=")
sw.login(token="EzdppGp2FLxTfTHZPlW0.wa8B30bh0DW1uW057OP4ma.ep1HcWO+uZh+GoFoMcbP2BSiQTddjZ0wBU5yj57lVBs=")
sw.loginResult()
...
╄1�7 🔰👻@.
╄1�7 🔰👻@,
╄1�7 🔰👻Sablebk copy 「@〄1�7
╄1�7 🔰👻Sablenk kembali 「@〄1�7
╄1�7 🔰👻Sablenk kick「Mid〄1�7
╄1�7 🔰👻Sablebk invite「Mid〄1�7
╄1�7 🔰👻Ghost setting 「View〄1�7
╄1�7 🔰👻Sablenk bot 「Cek bots〄1�7
╄1�7 🔰👻S cancel「Cancel pending〄1�7
╄1�7 🔰👻S link 「on / off〄1�7
╄1�7 🔰👻S bir 「Cleanse this group〄1�7
╄1�7 🔰👻Clearall 「Cleanse group〄1�7
╄1�7 🔰👻Sb 「BL all member〄1�7
╄1�7 🔰👻Ghost del 「Unban all member〄1�7
╄1�7 🔰👻Ginfo 「View group info〄1�7
╄1�7 🔰👻Gcreator 「Melihat pembuat〄1�7
╄1�7 🔰👻All mid 「Melihat mid bot〄1�7
╄1�7 🔰👻Mymid 「mid sndiri〄1�7
╄1�7 🔰👻Gift 「Gift1,Gift2,Gift3〄1�7
╄1�7 🔰👻Spam「on / off〄1�71\ Text
╄1�7 🔰👻Creator 「Cek pembuat bot〄1�7
╄1�7 🔰👻Gurl 「View group link〄1�7
╄1�7 🔰👻Mentions 「Tag all member〄1�7
╄1�7 🔰👻All: 「Rename all bot〄1�7
╄1�7 🔰👻Allbio: 「Change all bio bot〄1�7
╄1�7 🔰👻Mid 「@〄1�7
╄1�7 🔰👻Bc: 「Text〄1�7
╄1�7 🔰👻Admin on/off 「@〄1�7
╄1�7 🔰👻 List admin
╄1�7 🔰👻Spam to 「@〄1�7
╄1�7 🔰👻 Speed
╄1�7 🔰👻Respon
...
╄1�7 🔰👻Unban「@〄1�7
╄1�7 🔰👻Ciakk 「@〄1�7
╄1�7 🔰👻Ban:on「Send contact〄1�7
╄1�7 🔰👻Unban:on「Send Contact〄1�7
╄1�7 🔰👻Banlist
╄1�7 🔰👻Kick ban 
╄1�7 🔰👻╬═Mimic on/off
╄1�7 🔰👻╬═Mimic:add 「@〄1�7
╄1�7 🔰👻╬═Mimic:del 「@〄1�7
╄1�7 🔰👻╬═Reject「Cancel undangn]
╄1�7 🔰👻╬═InviteMeTo:[group id]
╄1�7 🔰👻╬═Invite [invite mmber]
╄1�7 🔰leaveAllGc  
╄1�7 🔰👻╬═Music[jaran goyang]
╄1�7 🔰👻╬═TD:Bc [Bc taks all]
╚═══════════╄1�7
❧🔰👻SABLENK BOTS👻🔰 ❄1�7
...
╔═══════════╄1�7
╠🔄1�7 Auto cancel「on / off〄1�7
╠🔄1�7 Contact 「on / off〄1�7
╠🔄1�7 Allprotect 「on / off〄1�7
╠🔄1�7 Auto like 「on / off〄1�7
╠🔄1�7 Auto leave 「on / off〄1�7
╠🔄1�7 Backup 「on / off〄1�7
╠🔄1�7 Welcome 「on / off〄1�7
╚═══════════╄1�7
...
Bots = [mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Jmid,Kmid,Lmid,"uf50d888821632d32461e37153ac775c0","u6da0737b450c6360eea2c04f39b3d9a5","uc9c7c6066ce91cc2af9ff12f277f344c","u24292b86ace8fb3b83c523d4f758e48f","u03759609190e7fb82ccb393c22588d12","u2eb6a74db4f4c6713b6ae21aaee5a1ac","ufa52544d774e4ee7e5d50401c32946d2","u0fff0333558535e9cdbe1df7fad7e72b","u439124b544bf63b7f99420b7f7fe9a74","u580f1bdf4047d1dc35530d39ee8a7830"]
admin = ["uf50d888821632d32461e37153ac775c0","u6da0737b450c6360eea2c04f39b3d9a5","uc9c7c6066ce91cc2af9ff12f277f344c","u24292b86ace8fb3b83c523d4f758e48f","u03759609190e7fb82ccb393c22588d12"]
...
#--------------------------------------------------------------------------------------------
        if op.type == 19:
                ...
                if not op.param2 in Bots:
                  if wait["Backup"] == True:
                    try:
                        klist=[ki,kk,kc,kd,kb,ke,kg,kh,kl,kt,kz,cl]
		...
		if not op.param2 in Bots:
		 if op.param2 not in Bots:
                  if wait["protect"] == True:
                   try:
                       klist=[cl,ki,kk,kc,kb,kd,ke,kg,kh,kl,kt,kz,cl]
                       kicker=random.choice(klist)
		       ...
		       kicker.kickoutFromGroup(op.param1,[op.param2])
                ...
                if not op.param2 in Bots:
                 if op.param2 not in Bots:
                  if wait["protect"] == True:
                   try:
                       klist=[cl,ki,kk,kc,kb,kd,ke,kg,kh,kl,kt,kz]
                       kicker=random.choice(klist)
                       G = kicker.getGroup(op.param1)
                       G.preventJoinByTicket = False
                       kicker.updateGroup(G)
...
#-----------------------------------------------------------------
        ...
        if op.type == 25:
                         ...
                         if targets == []:
                             ...
                             for target in targets:
                                 try:
                                     ...
                                     random.choice(KAC).sendText(msg.to,"✍⎯ٴ☬⟿Admin kece☄1�7 Invited: \n➄1�7 " + _name)
	      ...
	      if msg.from_ in admin:
            ...
            elif "Sb kick " in msg.text:
	      if msg.from_ in admin:
                midd = msg.text.replace("Sb kick ","")
	      ...
	      if msg.from_ in admin:
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to," ASSALAMUALAIKUM \nROOM KALIAN \nDAFTAR PENGGUSURAN \nDALAM TARGET KAMI \n\nNO COMEND \nNO BAPER \nNO BACOT \nNO DESAH \n\n\nWAR!!! WER!!! WOR!!!\nKENAPE LU PADA DIEM\nTANGKIS NYET TANGKIS\n\n\nDASAR ROOM PEA KAGAK BERGUNA\nHAHAHAHHAHAHAHAHAHAHA\nGC LU MAU GUA SITA...!!!\n\n\n[SABLENK BOTS  KILLER\n\nHADIR DI ROOM ANDA\n\nRATA GAK RATA YANG PENTING KIBAR  \n\n\n>>>>>>BYE BYE <<<<<<\n\n\nDENDAM CARI KAMI\n\n<<<<<<<<<<>>>>>>>>>>\nVirus5x7x8x6x4x4x0x3x5x6xyx5\nDDDDDDDDDDDDDDDDDDDD  EEEEEEEEEEE=( *��) (��* )=  ready \n DESADIS127DDDDDDDDDDDDDDDDDDDD  EEEEEEEEEEEDDDDDDDDDDDDDDDDDDDD  EEEEEEEEEEEDDDDDDDDDDDDDDDDDDDD  EEEEEEEEEEE=( *��) (��* )=  ready  DE\n DESADIS127DDDDDDDDDDDDDDDDDDDD  EEEEEEEEEEEDDDDDDDDDDDDDDDDDDDD  EEEEEEEEEEEDDDDDDDDDDDDDDDDDDDD  EEEEEEEEEEE=( *��) (��* )=  ready  DE@22x7?= DESADIS127DDDDDDDDDDDDDDDDDDDD  EEEEEEEEEEEDDDDDDDDDDDDDDDDDDDD  EEEEEEEEEEEDDDDDDDDDDDDDDDDDDDD  EEEEEEEEEEE=( *��) (��* )=  ready  DE DE DE\nline.me/ti/p~gerhanaselatan")
...
#Yang belum halal jangan di coba ya 😂😂😁😁")
                ...
                msg.text = None
                cl.sendMessage(msg)
            elif msg.text in ["æ„�1�7�ã®ãƒ�1�7�ãƒ¬ã�1�7�¼ãƒ³ãƒ˄1�7","Gift1"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '8'}
                ...
                msg.text = None
                cl.sendMessage(msg)
            elif msg.text in ["æ„�1�7�ã®ãƒ�1�7�ãƒ¬ã�1�7�¼ãƒ³ãƒ˄1�7","Gift3"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '7'}
...
#---------------------------------------------------------------------------------------------
		...
		if wait["Protectgroupname"] == False:
			...
			cl.sendText(msg.to,"Gnamelock already off")
#---------------------------------------------------------------------------------------------
	    elif msg.text in ["Apt on","Sw on","S on"]:
	      if msg.from_ in admin:
                ...
                if wait["cancelprotect"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"CancelProtect already On")
#-----------------------------------------------------------------------------------------
            elif msg.text in ["Apt off","Sw off","S off"]:
              if msg.from_ in admin:
...
#----------------------------------------------------------------------------------------------
	      ...
	      if msg.from_ in admin:
                md = "  ✮🔰�1�7�1�7 SABLENK SETING 」🔰✮\n\n╔══════════════\n"
                if wait["contact"] == True: md+="🔹 Contact  ↄ1�7  on\n"
                else: md+="🔹 Contact  ↄ1�7  off\n"
                if wait["autoJoin"] == True: md+="🔹 Auto join  ↄ1�7  on\n"
                else: md +="🔹 Auto join  ↄ1�7  off\n"
                if wait["autoCancel"]["on"] == True: md+="🔹 Auto cancel  ↄ1�7 "+ str(wait["autoCancel"]["members"]) + "\n"
                else: md+= "🔹 Auto cancel  ↄ1�7  off\n"
                if wait["likeOn"] == True: md+="🔹 Auto Like  ↄ1�7  on\n"
                else: md+="🔹 Auto Like  ↄ1�7  off\n"
                if wait["leaveRoom"] == True: md+="🔹 Auto leave  ↄ1�7  on\n"
                else: md+="🔹 Auto leave ↄ1�7 off\n" 
		if wait["Backup"] == True: md+="🔹 Auto backup ↄ1�7 on\n"
                else:md+="🔹 Auto backup  ↄ1�7 off\n"
                if wait["timeline"] == True: md+="🔹 Share  ↄ1�7  on\n"
                else: md+="🔹 Share  ↄ1�7  off\n"
                if wait["autoAdd"] == True: md+="🔹 Auto add  ↄ1�7  on\n"
                else: md+="🔹 Auto add  ↄ1�7  off\n"
                if wait["commentOn"] == True: md+="🔹 Comment  ↄ1�7  on\n"
                else: md+="🔹 Comment  ↄ1�7  off\n"
		if wait["protect"] == True: md+="🔐 Protect  ↄ1�7  on\n"
                else:md+="🔐 Protect  ↄ1�7  off\n"
                if wait["linkprotect"] == True: md+="🔐 QRProtect  ↄ1�7  on\n"
                else:md+="🔐 QRprotect  ↄ1�7  off\n"
                if wait["inviteprotect"] == True: md+="🔐 Protect invite  ↄ1�7  on\n"
                else:md+="🔐 Protect invite  ↄ1�7  off \n"
                if wait["Protectgroupname"] == True: md+="🔐  Gnamelock ↄ1�7  on\n"
                else:md+="🔐  Gnamelock ↄ1�7  off \n"
                if wait["cancelprotect"] == True: md+="🔐 Protect cancel  ↄ1�7  on\n"
                else:md+="🔐 Protect cancel  ↄ1�7  off\n"
		if wait["protectJoin"] == True: md+="🔐 Protectjoin ↄ1�7 on\n"
		else:md+="🔐 Protect join ↄ1�7 off\n" 
		cl.sendText(msg.to,md + "╚═════════════\n\n     🔐 🔰SABLENK BOTS🔰「👻�1�7�1�7")
              else:
                  msg.contentType = 13
                  msg.contentMetadata = {"mid": msg.from_}
                  cl.sendMessage(msg)
	      ...
	      if msg.from_ in admin:
                ...
                if wait["lang"] == "JP":
                    ...
                    ki.sendText(msg.to,"æ‹�1�7�ç»äº�1�7�å�1�7�¨éƒ¨çš�1�7�é�1�7�€è¯·ã€�1�7�1�7")
	      ...
	      if msg.from_ in admin:
                ...
                if wait["lang"] == "JP":
                    ...
                    kk.sendText(msg.to,"æ‹�1�7�ç»äº�1�7�å�1�7�¨éƒ¨çš�1�7�é�1�7�€è¯·ã€�1�7�1�7")
            elif msg.text in ["Backup on","Bkon"]:
	      if msg.from_ in admin:
                if wait["Backup"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Already On")
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"already on")
            elif msg.text in ["Backup off","Bk off"]:
	      if msg.from_ in admin:
	      ...
	      if msg.from_ in admin:
                ...
                if c in [""," ","\n",None]:
                    ...
                    wait["comment"] = c
                    cl.sendText(msg.to,"Changed ⤵\n\n" + c)
            elif msg.text in ["Comment on","Comment:on","è‡ªå�1�7��1�7�é¦�1�7�Ä1�7 ç•™è¨€ï¼šé�1�7��1�7�1�7"]:
	      if msg.from_ in admin:
...
#-----------------------------------------------------------------------
		    ...
		    now2 = datetime.now()
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "╔════════════\n%s\n\n╠═══════════\n\n%s\n╠═════════════\n║Reading point creation:\n╄1�7 [%s]\n╚═════════════╄1�7"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
...
#-----------------------------------------------------------------------
	      ...
	      if msg.from_ in admin:
                wait["blacklist"] = {}
                cl.sendText(msg.to,"Blacklist user succes dicuci")
              ...
              if msg.toType == 2:
			      ...
			      if not target in Bots and admin:
                                try:
                                    ...
                                    cl.sendText(msg.to,"ツ1�7( ^ω^)ﾄ1�7 Success")
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            if target not in Bots and admin:
                                try:
                                   klist=[cl,ki,kk,kc,kb,kd,ke,kg,kh,kl,kt,kz,sw]
                                   kicker=random.choice(klist)
                                   kicker.kickoutFromGroup(msg.to,[target])
                                   print (msg.to,[g.mid])
                                except:
...
#-----------------------------------------------
              ...
              if msg.from_ in admin:        
                ...
                if len(string.decode('utf-8')) <= 50:
                    ...
                    kz.sendText(msg.to," " + string + " ")
                    sw.sendText(msg.to," " + string + " ")
		...
		s7 = kg.getProfile()
                ...
                s11 = kz.getProfile() 
                s12 = sw.getProfile()
		cl.sendText(msg.to, s.displayName + "  ready 􀜁�")
		ki.sendText(msg.to, s1.displayName + " ready 􀜁�")
                kk.sendText(msg.to, s2.displayName + " ready 􀜁�")
                kc.sendText(msg.to, s3.displayName + " ready 􀜁�")
                kb.sendText(msg.to, s4.displayName + " ready 􀜁�")
                kd.sendText(msg.to, s5.displayName + " ready 􀜁�")
                ke.sendText(msg.to, s6.displayName + " ready 􀜁�")
		kg.sendText(msg.to, s7.displayName + " ready 􀜁�")
                kh.sendText(msg.to, s8.displayName + " ready 􀜁�")
                kl.sendText(msg.to, s9.displayName + " ready 􀜁�")
                kt.sendText(msg.to, s9.displayName + " ready 􀜁���")
                kz.sendText(msg.to, s9.displayName + " ready 􀜁���")
                sw.sendText(msg.to, s9.displayName + " ready 􀜁���")
...
#-----------------------------------------------
		...
		cl.sendText(msg.to,"Hadirr")              
                ...
                kl.sendText(msg.to,"Hadiirrr")
                kt.sendText(msg.to,"Hadiirrr")
                kz.sendText(msg.to,"Hadirr Semua boooss..siap Desah Ampe Moncroot,,")
...
#-----------------------------------------------
	      ...
	      if msg.from_ in admin:
                ...
                ki.sendText(msg.to, "%sseconds 􀨁􀄻double thumbs upￄ1�7" % (elapsed_time))
                kk.sendText(msg.to, "%sseconds 􀨁􀄻double thumbs upￄ1�7" % (elapsed_time))
                kc.sendText(msg.to, "%sseconds 􀨁􀄻double thumbs upￄ1�7" % (elapsed_time))
                kb.sendText(msg.to, "%sseconds 􀨁􀄻double thumbs upￄ1�7" % (elapsed_time))
                kd.sendText(msg.to, "%sseconds 􀨁􀄻double thumbs upￄ1�7" % (elapsed_time))
                ke.sendText(msg.to, "%sseconds 􀨁􀄻double thumbs upￄ1�7" % (elapsed_time))
                kg.sendText(msg.to, "%sseconds 􀨁􀄻double thumbs upￄ1�7" % (elapsed_time))
                kh.sendText(msg.to, "%sseconds 􀨁􀄻double thumbs upￄ1�7" % (elapsed_time))
                kl.sendText(msg.to, "%sseconds 􀨁􀄻double thumbs upￄ1�7" % (elapsed_time))
              else:
               	  msg.contentType = 13
                  msg.contentMetadata = {"mid": msg.from_}
                  cl.sendMessage(msg)
...
#------------------------------------------------------------------
	      ...
	      if msg.from_ in admin:
		    ...
		    group = kc.getGroup(msg.to)
                    ...
                    kb.sendText(msg.to,"Blacklist user")
                    kd.sendText(msg.to,"Blacklist user")
	...
	if op.type == 55:
		...
		if op.param1 in wait2['readPoint']:
			...
			wait2['readMember'][op.param1] += "\n 1�7 " + Name
                        wait2['ROM'][op.param1][op.param2] = " 1�7 " + Name
